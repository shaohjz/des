...
public class DesUtil {
	...
	// 特别注意：xxx[IP[i]-1]等类似变换
	 ...
	 public static void main(String[] args) {
	  ...
	  String data ="02468aceeca86420";
	  DesUtil desUtil = new DesUtil(key);
	  System.err.println("加密前明文：" + data);
	  // 加密后的byte型的密文
	  byte[] result = desUtil.DesEncrypt(data.getBytes(), 1);
	  System.out.println("加密后密文：" + new String(result));
	  // 下句直接把byte类型的密文解密
	  System.out.println("解密后明文："+ new String(desUtil.DesEncrypt(result, 0)));
	  String str = "02468aceeca86420";
